...
export default function HaylingIslandRecovery() {
  useEffect(() => {
    document.title = "Vehicle Recovery Hayling Island | 24/7 Breakdown Assistance";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Stranded on Hayling Island? Get rapid 24/7 vehicle recovery and breakdown assistance. Our local network reaches you fast in Mengham, West Town, and on the A3023.');
    }
  }, []);
      ...
      <section className="relative py-20 md:py-32 bg-brand-dark text-white overflow-hidden">
        <div className="absolute inset-0 z-0 opacity-50">
          <img
            ...
            alt="Vehicle Recovery in Hayling Island"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-black leading-tight mb-6 uppercase tracking-tighter">
              Vehicle Recovery in <span className="text-brand-orange">Hayling Island</span>
            </h1>
            <p className="text-lg md:text-xl text-gray-300 mb-4 leading-relaxed font-medium">
              Fast vehicle recovery, breakdown help, and roadside assistance across Hayling Island 24/7.
            </p>
            <p className="text-lg md:text-xl text-gray-300 mb-8 leading-relaxed font-medium">
              Need vehicle recovery in Hayling Island right now? We help with non-starters, breakdowns, accident-damaged vehicles, and safe transport to your garage or home. Whether you are stuck in Mengham, West Town, the town centre, or near Hayling Island Beach, call for quick local support.
            </p>
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
              ...
              >
                ...
                Call now for vehicle recovery in Hayling Island
              </a>
            </div>
          </motion.div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <h2 className="text-2xl md:text-4xl font-black mb-8 uppercase tracking-tight text-brand-dark">
                How to get car recovery in Hayling Island quickly
              </h2>
              ...
              <h2 className="text-2xl md:text-4xl font-black mb-8 uppercase tracking-tight text-brand-dark">
                Common Hayling Island callouts
              </h2>
              <ul className="space-y-4 mb-12">
                {[
                  "A3023 approach-route breakdowns entering or leaving the area",
                  "Hayling Island Beach area non-starts, including flat battery issues after parking",
                  "Town-centre and Mengham Shops callouts from shopping and multi-storey car parks",
            ...
            <div className="space-y-12">
              <div className="bg-brand-dark p-8 md:p-12 rounded-sm text-white shadow-2xl">
                <h3 className="text-xl md:text-2xl font-black mb-6 uppercase tracking-widest text-brand-orange">
                  Key Hayling Island recovery routes
                </h3>
                <ul className="space-y-4">
                  {[
                    "A3023 (Langstone Road / Havant Road)",
                    "A3023 (Manor Road)",
                    "A3023 (Church Road)",
                    "Sea Front",
                    "Ferry Road"
              ...
              <div>
                <h2 className="text-2xl md:text-4xl font-black mb-8 uppercase tracking-tight text-brand-dark">
                  What to tell us when you call from Hayling Island
                </h2>
                <ul className="space-y-4">
                  {[
      ...
      <section className="relative py-16 md:py-32 bg-brand-orange text-black overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-2xl sm:text-3xl md:text-6xl font-black mb-4 md:mb-8 leading-tight uppercase">
            Need Help in Hayling Island? <span className="text-white">Call Us Now.</span>
          </h2>
